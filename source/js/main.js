...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (screen.width < 1024) {
    var cutText = document.querySelector('.about__wrapper p:last-of-type').textContent.substr(0, 200) + '...';
    document.querySelector('.about__wrapper p:last-of-type').textContent = cutText;
  }
